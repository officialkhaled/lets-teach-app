...
class pageDialogs {
    ...
    static sweetAlert2() {
        ...
        let toast = Swal.mixin({
            buttonsStyling: false, target: '#page-container', customClass: {
        ...
        if (swalConfirmDelete) {
            swalConfirmDelete.addEventListener('click', e => {
                toast.fire({
                    ...
                    customClass: {
                        confirmButton: 'btn btn-danger m-1', cancelButton: 'btn btn-secondary m-1'
                    },
        ...
        if (swalCustom) {
            swalCustom.addEventListener('click', e => {
                toast.fire({
                    position: 'top-end', title: 'Perfect!', text: 'Nice Position!', icon: 'success'
                });
            });
        }
    }
